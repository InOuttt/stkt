...
func (c *movieServiceClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/MovieService/Search", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) Detail(ctx context.Context, in *DetailRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/MovieService/Detail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMovieServiceServer) Search(context.Context, *SearchRequest) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Search not implemented")
}
func (UnimplementedMovieServiceServer) Detail(context.Context, *DetailRequest) (*Response, error) {
...
func _MovieService_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MovieService/Search",
	}
...
func _MovieService_Detail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MovieService/Detail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
